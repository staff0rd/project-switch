...
- [ ] Task: Evaluate GUI framework (iced vs egui/eframe) — build a minimal prototype with text input + scrollable list for both, compare startup time, keystroke latency, binary size, and cross-platform support. Document decision in tech-stack.md.
